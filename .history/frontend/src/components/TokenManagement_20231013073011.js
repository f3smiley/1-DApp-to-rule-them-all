...
/*
This code is written twice and in a wrong place in the `initContracts` hook. The
second time it appears, it's inserted between the declaration and initialization
of `mintableTokenInstance` which is a syntax error.
